...
class DatasetCatalog:
    def __init__(self, ROOT):
        ...
        self.Pidray = {
            'target': 'dataset.pidray_dataset.PIDrayDataset',
            'train_params': dict(
                #pidray
                #pidray_path = '/home/ct/data/sjl/diffusion/pidray_low_resolution/gligen/pidray_train_gligen_seg_image_project.pt',
                #image_path = '/home/ct/data/sjl/diffusion/pidray_low_resolution/train/',

                #hixray
                # pidray_path = '/home/ct/data/sjl/diffusion/hixray/gligen/hixray_train.pt',
                # image_path = '/home/ct/data/lwz/dataset/HiXray/train/train_image'

                #opiray
                pidray_path = '/home/ct/data/sjl/diffusion/opiray/gligen/opiray_train.pt',
                image_path = '/home/ct/data/lwz/dataset/OPIXray/train/train_image'
            )
        }
        
        self.PidrayDepth = {
            'target': 'dataset.pidray_dataset.PIDrayDepthDataset',
            'train_params': dict(
                pidray_path = '/home/ct/data/sjl/diffusion/pidray_low_resolution/gligen/pidray_train_gligen_seg_image_project.pt',
                image_path = '/home/ct/data/sjl/diffusion/pidray_low_resolution/train/',
                depth_path = '/home/ct/data/sjl/diffusion/pidray_low_resolution/depth/train'
            )
        }
