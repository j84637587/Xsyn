...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path", type=str,  default='/home/ct/data/sjl/gligen_official_hixray/text_box/tag00/checkpoint_00180000.pth', help="")
    parser.add_argument("--new_ckpt_path", type=str,  default='/home/ct/data/sjl/gligen_official_hixray/text_box/tag00/checkpoint_00180000_inpaint_start.pth', help="")
